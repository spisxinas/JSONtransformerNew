		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#jsontransformer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jsontransformer-display": {
								"semanticObject": "jsontransformer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jsontransformer",
									"url": sap.ui.require.toUrl("jsontransformer")
								}
							}
						}
					}
